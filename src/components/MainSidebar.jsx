...
const filters = [
  {
    ...
    name: "Category",
    options: [
      { value: "car-care", label: "Car Care", checked: false },
      { value: "car-covers", label: "Car Covers", checked: false },
      { value: "car-air-freshers", label: "Car Air Freshers", checked: true },
      { value: "microfiber-cloth", label: "Microfiber Cloth", checked: false },
      {
        value: "car-engine-cleaners",
        label: "Car Engine Cleaners",
        checked: false,
      },
      { value: "car-wax", label: "Car Wax", checked: false },
      {
        value: "car-interior-cleaners",
        label: "Car Interior Cleaners",
        checked: false,
      },
      { value: "car-coolants", label: "Car Coolants", checked: false },
      { value: "car-shampoo", label: "Car Shampoo", checked: false },
      {
        value: "car-wheel-cleaners",
        label: "Car Wheel Cleaners",
        checked: false,
      },
      { value: "car-polish", label: "Car Polish", checked: false },
    ],
  },
  {
    id: "make",
    ...
    options: [
      ...
      { value: "suzuki", label: "Suzuki", checked: true },
      { value: "daihatsu", label: "Daihatsu", checked: false },
  ...
  },
  {
    ...
    name: "Brand",
    options: [
      { value: "mk", label: "MK", checked: false },
      { value: "asuki", label: "Asuki", checked: false },
      { value: "asukiadvanced", label: "Asuki Advanced", checked: false },
      { value: "tyc", label: "TYC", checked: false },
      { value: "denso", label: "Denso", checked: false },
      { value: "airpro", label: "Airpro", checked: true },
    ],
  },
];
