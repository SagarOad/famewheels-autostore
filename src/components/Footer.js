        ...
        <div className=" max-w-[1350px] mx-auto">
          <div className="grid grid-cols-12 mb-10 border-b-2 border-[#a3a3a36f]">
            ...
            <div className=" lg:col-span-4 mb-6 col-span-12 flex lg:justify-end items-center">
              <div className="">
                <p className=" text-[#000000] font-[20px]">GIVE US A CALL</p>
                <h2 className=" text-[20px] font-bold">+1 302-501-7152</h2>
              </div>
            </div>
          </div>

          <div className=" grid grid-cols-12">
            <div className=" lg:col-span-4 sm:col-span-6 col-span-12 md:mr-24">
            ...
            <div className=" lg:col-span-4 sm:col-span-6 lg:pl-24 mt-6 md:mt-0 col-span-12">
              <h2 className=" text-[18px] font-[800] md:mb-8 mb-2">Quick Links</h2>
              <ul>
                <li className=" flex items-center text-[16px] cursor-pointer border-b-[1px] p-1 border-transparent hover:border-primary w-fit">
                  Categories
                </li>
                <li className=" flex items-center text-[16px] cursor-pointer border-b-[1px] p-1 border-transparent hover:border-primary w-fit">
                  Brands
            ...
            <div className=" lg:col-span-4 sm:col-span-6 lg:pl-24 mt-6 md:mt-0 col-span-12">
              <h2 className=" text-[18px] font-[800] md:mb-8 mb-2">Contact</h2>
              <ul>
                <li className=" flex items-center text-[16px] mb-4">
                214, The Plaza, Clifton Block 9,Karachi, Pakistan.
                </li>
                <li className=" flex text-[16px] items-center mb-4">support@famewheels.com</li>
                <li className=" flex text-[16px] items-center mb-2">03001113263</li>
              </ul>
            </div>
